package com.example.android.aigames.sudoku.tagSphere.item

import android.graphics.Canvas
import android.graphics.PointF
import android.text.TextPaint
import com.example.android.aigames.sudoku.tagSphere.Point3d
...
abstract class TagItem : Comparable<TagItem> {
    ...
    open fun setTagId(tagId: String) {
        this.tagId = tagId;
    }

    open fun getTagId() = tagId
